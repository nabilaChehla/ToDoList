...
<body >
    ...
    <header class=''>
        <nav class="nav-list">
            <li class='current-link'><a href="index.php">Tasks</a> <img src='./images/icons8-to-do-48.png'></li>   
            <li><a href="projects.php">Projects</a><img src='./images/icons8-project-64.png'></li>    
            <li><a href="category.php">Category</a><img src='./images/icons8-category-48.png'></li>    
            <li><a href="login.php">Change User</a><img src='./images/icons8-user-48.png'></li>   
    ...
    <div class='container'>
        ...
        <a class='link-completed-task' href="completed_tasks.php">SEE COMPLETED PROJECTS</a>
    </div>
</body>
</html>
